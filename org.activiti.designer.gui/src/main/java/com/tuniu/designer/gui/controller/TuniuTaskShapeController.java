 ...
 */
public class TuniuTaskShapeController extends AbstractBusinessObjectShapeController {
  
  private static final int IMAGE_SIZE = 16;
  
  public TuniuTaskShapeController(ActivitiBPMNFeatureProvider featureProvider) {
